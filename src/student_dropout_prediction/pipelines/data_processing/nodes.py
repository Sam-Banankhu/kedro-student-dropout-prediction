...
def prepare_features(df: pd.DataFrame) -> tuple:
    ...
    # Select features
    feature_columns = ['term_avg_score', 'school_attendance_rate', 'bullying_incidents_total', 
